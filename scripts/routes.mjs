...
export const routes = [
  ...
  { slug: 'aurum-bot', title: '▲ Aurum Bot: Robô Zeus AI da Aurum Foundation', description: '▲ Aurum Bot (Zeus AI): o robô de trading cripto da Aurum Foundation que opera 24/7. Como ativar, custos ▼, riscos e diferenças entre os planos.', ogType: 'article', changefreq: 'weekly', priority: '0.9' },
  { slug: 'aurum-foundation-e-confiavel', title: '▲ Aurum Foundation é Confiável? Análise Completa', description: '▲ Aurum Foundation é confiável? Veja licenças, segurança, custódia, reputação, reviews e riscos ▼ antes de investir. Análise transparente e completa.', ogType: 'article', changefreq: 'monthly', priority: '0.9' },
